...
def run_genetic_algorithm(toolbox, population_size, generations, p_crossover, p_mutation):
    ...
    best = hof[0]
    best_individual_df = pd.DataFrame(best)
...
def main():
    ...
    random.seed(20)
    toolbox = setup_toolbox(fleet)
    best = run_genetic_algorithm(toolbox, population_size=50, generations=100, p_crossover=0.9, p_mutation=0.1)
